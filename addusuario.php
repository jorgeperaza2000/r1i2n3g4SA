                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6" style="float:none !important; margin: auto;">
                            ...
                            <div class="box box-primary">
                                ...
                                <!-- form start -->
                                <form role="form" action="<?=$urlWebServiceClient?>clienteUsuarios.php?accion=1" autocomplete="off" method="post">
                                    <div class="box-body">
                                    	<?php
	                                    showNotificacion();
	                                    ?>						                	
	                                    ...
	                                    <div class="form-group">
	                                        ...
	                                        <input type="password" name="txtReClave" id="txtReClave" class="form-control" placeholder="Repita la Clave">
	                                    </div>
	                                    <div class="form-group">
	                                        <label for="txtExtension">Extension</label>
	                                        <input type="text" name="txtExtension" id="txtExtension" class="form-control" placeholder="Extension en caso de ser necesario">
	                                    </div>
	                                    <?php
