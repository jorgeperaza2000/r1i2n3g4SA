            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        Agregar Punto Virtual
                        <small>Puntos Virtuales</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="home.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
                        <li class="active">Agregar Puntos Virtuales</li>
                    </ol>
                </section>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6" style="float:none !important; margin: auto;">
                            ...
                            <div class="box box-primary">
                                ...
                                <!-- form start -->
                                <form role="form" id="frmAddVirtualPoint" action="includes/functions.php?op=nuevoVirtualPoint" autocomplete="off" method="post">
                                    <div class="box-body">
	                                    ...
	                                    <div class="form-group">
	                                        ...
	                                        <input type="text" name="txtCodAfiliacion" id="txtCodAfiliacion" class="form-control" placeholder="Afiliaci&oacute;n">
	                                    </div>
	                                    <div class="form-group">
	                                        <label for="txtTranscode">Transcode</label>
	                                        <input type="text" name="txtTranscode" id="txtTranscode" class="form-control" placeholder="Transcode">
	                                    </div>
	                                    <?php
